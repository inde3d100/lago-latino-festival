...
const artists: PersonData[] = [
  ...
  { name: "Kiko & Magda", role: "Instructor / Performer", country: "Greece", image: imgKikoMagda, imagePosition: "50% 0%" },
  ...
  { name: "Korina Visvardi", role: "Instructor / Performer", country: "Greece", image: imgKorinaVisvardi },
...
const videographers: PersonData[] = [
  { name: "Fanis Tsekos", role: "Videographer", country: "Greece", image: imgFanisTsekos, imagePosition: "50% 5%" },
